System.register([], function(exports_1, context_1) {
    ...
    var DankoQuotesService;
    return {
        setters:[],
        execute: function() {
            class DankoQuotesService {
                constructor() {
                    this.quotes = [
                ...
                getQuotes(quotesToSend) {
                    var bufferNumbers = new Array();
                    var bufferQuotes = new Array();
            ...
            exports_1("DankoQuotesService", DankoQuotesService);
        }
    }
});
//# sourceMappingURL=danko-quotes.service.js.map